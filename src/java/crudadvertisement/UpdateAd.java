 ...
 * @author pc
 */
@WebServlet(name = "UpdateAd", urlPatterns = {"/UpdateAd"})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet UpdateAd</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet UpdateAd at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
        ...
        if (a != null) {
            ...
            dao.updateAdvertisement(Long.parseLong(ad_id));
