...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <%
            ...
            List<Category> cat = dao.getAllCategory2();
            Category p = new Category();
            String cat_id = "";
            if (request.getParameter("category") != null) {
                cat_id = request.getParameter("category");
                cat = dao.getCategoryById(Long.parseLong(cat_id));
                p.setCategoryId(cat.get(0).getCategoryId());
                p.setCatTitle(cat.get(0).getCatTitle());
                p.setSlug(cat.get(0).getSlug());
                p.setIcon(cat.get(0).getIcon());
            }
        %>
