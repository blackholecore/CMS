            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4" style="max-width: 750px;">
                        <h1 class="mt-4">Tài khoản đăng nhập</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tạo tài khoản mới</li>
                        </ol>

                        <form action="CreateUser" method="POST" class="row g-3">
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Họ tên</label>
                                <input type="text" class="form-control" name="fullname" required="Mời bạn nhập họ tên!" maxlength="50">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="file" class="form-control" name="avatar" required="Mời bạn thêm hình ảnh" maxlength="70">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="email" placeholder="Viết tóm tắt ở đây ...">
                            </div>
                            <div class="col-12">
                                <label for="inputAddress" class="form-label">Mật khẩu</label>
                                <input type="password" class="form-control" name="password" placeholder="Mật khẩu ..." maxlength="32">
                            </div>
                            <div class="col-12">
                                <label for="inputAddress2" class="form-label">Địa chỉ</label>
                                <input type="text" class="form-control" name="address" placeholder="Điền địa chỉ ở đây ...">                            
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Là thành viên</label>
                                <select name="isMember" class="form-select">
                                    <!--                                    <option selected>Chọn trạng thái</option>-->
                                    <option selected value="True">Kích hoạt</option>
                            ...
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Là Admin</label>
