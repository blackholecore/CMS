                ...
                <main>
                    <div class="container-fluid px-4" style="max-width: 750px;">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tạo comment mới</li>
                        </ol>

                        <form action="CreateComment" method="POST" class="row g-3">
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Tiêu đề</label>
                                <input type="text" class="form-control" name="comment_title" required="Mời bạn nhập tiêu đề!" maxlength="60">
                            </div>
                            
                             <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Họ tên</label>
                                <input type="text" class="form-control" name="comment_fullname" required="Mời bạn nhập họ tên!" maxlength="60">
                            </div>
                            
                            <div class="col-12">
                                <label for="inputAddress2" class="form-label">Nội dung</label>
                                <textarea rows="15" cols="100" class="form-control" id="content" name="content" placeholder="Nội dung comment ..."></textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label for="inputState" class="form-label">Bài viết</label>
                                <select name="post_id" class="form-select">
                                    <option selected>Chọn bài viết bình luận</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="comment_email" required="Mời bạn nhập tiêu đề!" maxlength="60">
                            </div>

                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Website</label>
                                <input type="text" class="form-control" name="comment_website" maxlength="60">
                            </div>
