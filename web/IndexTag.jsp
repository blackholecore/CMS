            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Thẻ bài viết - Tag</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Danh sách tag</li>
                            <li class="breadcrumb-item active"><a  href="CreateTag.jsp" class="btn btn-danger"><i class="fa fa-pen"></i> Tạo thẻ bài viết</a></li>
                        </ol>
                        <div class="row">
                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr >
                                            ...
                                            <th class="text-center" style="vertical-align: middle">Tên thẻ</th>
<!--                                            <th class="text-center" style="vertical-align: middle">Post Id</th>-->
