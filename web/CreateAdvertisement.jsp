            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4" style="max-width: 750px;">
                        <h1 class="mt-4">Quảng cáo (bên thứ ba)</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Tạo quảng cáo mới</li>
                        </ol>

                        <form action="CreateAdvertisement" method="POST" class="row g-3">
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Banner hiển thị</label>
                                <input type="file" class="form-control" name="image" >
                            </div>

                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Liên kết (link)</label>
                                <input type="text" class="form-control" name="link" required="Mời bạn nhập họ tên!" maxlength="60">
                            </div>

                            <div class="col-md-6">
                                <label for="inputAddress2" class="form-label">Ngày bắt đầu</label>
                                <input type="date" class="form-control" name="from_date">
                            </div>

                            <div class="col-md-6">
                                <label for="inputAddress2" class="form-label">Ngày hết hạn</label>
                                <input type="date" class="form-control" name="to_date">
                            </div>
                            
                            <div class="col-md-6">
                                <label for="inputAddress2" class="form-label">Ngày cập nhật</label>
