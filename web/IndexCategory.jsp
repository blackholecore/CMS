                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr >
                                            ...
                                            <th class="text-center" style="vertical-align: middle">Chủ đề</th>
                                            <th class="text-center" style="vertical-align: middle">Slug</th>
                                    ...
                                    <tbody>
                                        <% for (Category p : dao.getAllCategory2() ) {%>
                                        <tr>
                                            <td class="text-center" style="vertical-align: middle;font-weight: bold"><%=p.getCategoryId() %></td>
                                            <td class="text-center" style="vertical-align: middle;font-weight: bold"><%=p.getCatTitle() %></td>
